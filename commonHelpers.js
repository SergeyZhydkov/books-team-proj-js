import"./assets/su-cdcfd17c.js";import{a as b,N as f}from"./assets/vendor-77e6b4aa.js";const R="https://books-backend.p.goit.global",Y="/books/category-list";async function P(){try{return(await b.get(`${R}${Y}`)).data}catch(t){console.error(t)}}document.querySelector(".main-content-page");const w=document.querySelector(".categories-list");P().then(t=>{N(t)}).catch(t=>{f.Notify.failure("Error"),console.log(t)});function N(t){const e=t.map(({list_name:n})=>`
